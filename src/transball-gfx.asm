...
shipvpanther:
    ...
    db #00,#00,#60,#e0,#e0,#20,#60,#60,#f0,#f0,#f0,#f0,#f0,#f0,#30,#00
    ; 45
    db #00,#00,#00,#00,#00,#0f,#7f,#7f,#3f,#0f,#17,#0b,#05,#01,#00,#00
    db #00,#00,#00,#18,#f8,#90,#10,#30,#e0,#e0,#e0,#e0,#c0,#c0,#c0,#00
    ; 67.5
    db #00,#00,#00,#00,#7f,#7f,#3f,#3f,#1f,#2f,#2f,#17,#17,#07,#03,#02
    db #00,#00,#00,#00,#00,#fc,#dc,#18,#30,#f0,#e0,#c0,#80,#00,#00,#00
    ; 90
    db #00,#00,#30,#3c,#3f,#3f,#5f,#5f,#5f,#5f,#3f,#3f,#3c,#30,#00,#00
    db #00,#00,#00,#00,#00,#c0,#f0,#1c,#1c,#f0,#c0,#00,#00,#00,#00,#00
    ; 112.5
    db #02,#03,#07,#17,#17,#2f,#2f,#1f,#3f,#3f,#7f,#7f,#00,#00,#00,#00
    db #00,#00,#00,#80,#c0,#e0,#f0,#30,#18,#dc,#fc,#00,#00,#00,#00,#00
    ; 135
    db #00,#00,#01,#05,#0b,#17,#0f,#3f,#7f,#7f,#0f,#00,#00,#00,#00,#00
    db #00,#c0,#c0,#c0,#e0,#e0,#e0,#e0,#30,#10,#90,#f8,#18,#00,#00,#00
    ; 157.5
    db #00,#00,#06,#19,#07,#3f,#ff,#7f,#1e,#0e,#07,#03,#00,#00,#00,#00
    db #00,#30,#f0,#f0,#f0,#f0,#f0,#f0,#60,#60,#20,#e0,#e0,#60,#00,#00
    ; 180
    db #00,#03,#3c,#3f,#1f,#1f,#0f,#0f,#06,#06,#02,#03,#01,#01,#00,#00
    db #00,#c0,#3c,#fc,#f8,#f8,#f0,#f0,#60,#60,#40,#c0,#80,#80,#00,#00
    ; 202.5
    db #00,#0c,#0f,#0f,#0f,#0f,#0f,#0f,#06,#06,#04,#07,#07,#06,#00,#00
    db #00,#00,#60,#98,#e0,#fc,#ff,#fe,#78,#70,#e0,#c0,#00,#00,#00,#00
    ; 225
    db #00,#03,#03,#03,#07,#07,#07,#07,#0c,#08,#09,#1f,#18,#00,#00,#00
    db #00,#00,#80,#a0,#d0,#e8,#f0,#fc,#fe,#fe,#f0,#00,#00,#00,#00,#00
    ; 247.5
    db #00,#00,#00,#01,#03,#07,#0f,#0c,#18,#3b,#3f,#00,#00,#00,#00,#00
    db #40,#c0,#e0,#e8,#e8,#f4,#f4,#f8,#fc,#fc,#fe,#fe,#00,#00,#00,#00
    ; 270
    db #00,#00,#00,#00,#00,#03,#0f,#38,#38,#0f,#03,#00,#00,#00,#00,#00
    db #00,#00,#0c,#3c,#fc,#fc,#fa,#fa,#fa,#fa,#fc,#fc,#3c,#0c,#00,#00
    ; 292.5
    db #00,#00,#00,#00,#00,#3f,#3b,#18,#0c,#0f,#07,#03,#01,#00,#00,#00
    db #00,#00,#00,#00,#fe,#fe,#fc,#fc,#f8,#f4,#f4,#e8,#e8,#e0,#c0,#40
    ; 325
    db #00,#00,#00,#18,#1f,#09,#08,#0c,#07,#07,#07,#07,#03,#03,#03,#00
    db #00,#00,#00,#00,#00,#f0,#fe,#fe,#fc,#f0,#e8,#d0,#a0,#80,#00,#00
    ; 347.5
    db #00,#00,#06,#07,#07,#04,#06,#06,#0f,#0f,#0f,#0f,#0f,#0f,#0c,#00
    db #00,#00,#00,#00,#c0,#e0,#70,#78,#fe,#ff,#fc,#e0,#98,#60,#00,#00

shipvpanther_thruster:
    ; 0
    ...
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    ; 67.5
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#20,#60,#30,#10,#00,#00,#00
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    ; 90
    db #00,#00,#00,#00,#00,#00,#40,#c0,#c0,#40,#00,#00,#00,#00,#00,#00
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    ; 112.5
    db #00,#00,#00,#10,#30,#60,#20,#00,#00,#00,#00,#00,#00,#00,#00,#00
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    ; 135
    db #00,#00,#00,#0c,#18,#10,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    ; 157.5
    db #00,#04,#0e,#18,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    ; 180
    ...
    ; 202.5
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    db #00,#20,#70,#18,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    ; 225
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    db #00,#00,#00,#30,#18,#08,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    ; 247.5
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    db #00,#00,#00,#08,#0c,#06,#04,#00,#00,#00,#00,#00,#00,#00,#00,#00
    ; 270
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    db #00,#00,#00,#00,#00,#00,#02,#03,#03,#02,#00,#00,#00,#00,#00,#00
    ; 292.5
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#04,#06,#0c,#08,#00,#00,#00
    ; 325
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#08,#18,#30,#00,#00,#00
    ; 347.5
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00
    db #00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#00,#18,#70,#20,#00
